...
$(document).ready(function () {
  "use strict";
  //init data for fruit component
  var data = { fruits: ["banana", "strawberry", "orange"]};
  //selector of container for component
  var el = '#content';
  //run it TODO: functionalize further for compose i.e. normalize and curry and encapsulate side-effects
  ed.uiSelector(el, viewportSize.getWidth(), ed.b_lis, data.fruits);
  //Set up counter and element to put it in
  var counter = 0;
  var newdiv = document.createElement('div');
  newdiv.setAttribute('id',"counter");
  $(el).parent().append(newdiv);
  var clicker_data = {};
  //act responsively and with different html returned
